...
delivery_type_list = [
    {
        "recipient_address": dict(
            code="270", city="Новосибирск", address="ул. Блюхера, 32"
        ),
        "shipment_point": "NSK279",
        "tariff_code": 138,
...
def delivery_request(delivery_type):
    ...
    delivery_request_obj.add_address(order, **delivery_type["recipient_address"])
    ...
    delivery_request_obj.add_service(
        order_element=order, code="COURIER_PACKAGE_A2", parameter="3"
    )
